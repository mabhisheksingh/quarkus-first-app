...
public class GlobalExceptionMapper implements ExceptionMapper<Exception> {
    ...
    public Response toResponse(Exception exception) {
        ExceptionEntity exceptionEntity = ExceptionEntity.builder().errorCode(Response.Status.INTERNAL_SERVER_ERROR.getStatusCode())
        ...
        if (exception instanceof BadRequestException) {
            ...
            exceptionEntity = ExceptionEntity.builder()
                    .errorCode(Response.Status.CONFLICT.getStatusCode())
                    .errorMessage(exception.getMessage())
                    .build();
            ...
            exceptionEntity = ExceptionEntity.builder()
                    .errorCode(Response.Status.NOT_MODIFIED.getStatusCode())
                    .errorMessage(exception.getMessage())
                    .build();
        } else if (exception instanceof RuntimeException) {
            exceptionEntity = ExceptionEntity.builder()
                    .errorCode(Response.Status.BAD_GATEWAY.getStatusCode())
                    .errorMessage(exception.getMessage())
                    .build();
        } else {
            exceptionEntity = ExceptionEntity.builder()
